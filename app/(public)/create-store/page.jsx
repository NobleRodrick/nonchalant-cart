    ...
    try {
      ...
      if (["approved", "rejected", "pending"].includes(data.status)) {
        ...
        switch (data.status) {
          case "approved":
            setMessage(
              "Your store has been approved, you can now add products to your store from the dashboard"
            );
            setTimeout(() => router.push("/store"), 5000);
            break;
          case "rejected":
            setMessage(
              "Your store request has been rejected, please contact admin for more information."
            );
            setTimeout(() => router.push("/store"), 5000);
            break;
          case "pending":
